...
async def create_category(
    ...
    # 检查分类名称是否已存在
    existing_category = category_service.get_category_by_name(category_create.name)
    ...
    new_category = category_service.create_category(category_create)
    return new_category
...
async def update_category(
    ...
    success = category_service.update_category(category_id, updates)
...
async def save_categories_batch(
    ...
    category_service.save_categories_batch(categories_data)
